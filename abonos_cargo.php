			...
			<input  hidden name="id_ventas" id="id_ventas" type="number" value="<?php echo $id_ventas?>">
				...
				<div class="container">					
					...
					<div class="row  ">
						...
						<div class="col-3 ">
							<label class="my-3" >Balance Actual</label> 
						
						</div>
						<div class="col-8">
								<input name="saldo_ventas" id="saldo_ventas"readonly type="number" class="form-control my-1"id="saldo_ventas" value="<?php echo $saldo_ventas?>">
					...
					<div class="col-8">
					<input name="cantidad_cargo" id="cantidad_cargo" class="form-control " TYPE="number">
					</div>
					</div>
					<div class="row">
					<div class="col-3 ">
					...
					<div class="col-8">
					<input name="importe_total_ventas" readonly type="number" class="form-control my-1"id="importe_total_ventas" value="<?php echo $saldo_ventas;?>">
					</div>
					</div>
				<div class="row mt-3">	
